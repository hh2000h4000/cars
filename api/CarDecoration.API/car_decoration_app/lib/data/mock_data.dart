...
class MockData {
  static final List<Shop> shops = [
    Shop(
      ...
      services: [
        const ShopServiceItem(name: 'تظليل حراري كامل', price: 1200, duration: '٢-٣ ساعات', description: 'أفلام 3M Crystalline'),
        const ShopServiceItem(name: 'أفلام حماية PPF', price: 2500, duration: '٤-٦ ساعات', description: 'XPEL Ultimate Plus'),
        const ShopServiceItem(name: 'تلميع نانو سيراميك', price: 800, duration: '٣ ساعات'),
        const ShopServiceItem(name: 'تنظيف وتعقيم شامل', price: 250, duration: 'ساعة'),
        const ShopServiceItem(name: 'إضاءة LED داخلية', price: 450, duration: 'ساعتان'),
      ],
    ...
    Shop(
      ...
      services: [
        const ShopServiceItem(name: 'تلميع نانو سيراميك', price: 900, duration: '٣ ساعات'),
        const ShopServiceItem(name: 'تنظيف داخلي وخارجي', price: 300, duration: 'ساعتان'),
        const ShopServiceItem(name: 'إضاءة LED', price: 500, duration: 'ساعتان'),
        const ShopServiceItem(name: 'حماية دهان', price: 1800, duration: '٤ ساعات'),
      ],
    ...
    Shop(
      ...
      tags: ['تظليل', 'صوتيات'],
      services: [
        const ShopServiceItem(name: 'تظليل حراري', price: 800, duration: 'ساعتان'),
        const ShopServiceItem(name: 'أنظمة صوتية', price: 2000, duration: '٣-٥ ساعات'),
        const ShopServiceItem(name: 'شاشات وكاميرات', price: 1500, duration: '٣ ساعات'),
      ],
    ...
    Shop(
      ...
      tags: ['جلود', 'إضاءة'],
      services: [
        const ShopServiceItem(name: 'تلبيس جلد فاخر', price: 3500, duration: 'يوم كامل'),
        const ShopServiceItem(name: 'إضاءة أمبيانس', price: 600, duration: 'ساعتان'),
        const ShopServiceItem(name: 'إضاءة LED داخلية', price: 400, duration: 'ساعة'),
      ],
    ...
    Shop(
      ...
      services: [
        const ShopServiceItem(name: 'أفلام حماية PPF', price: 2200, duration: '٤ ساعات'),
        const ShopServiceItem(name: 'تلميع سيراميك', price: 750, duration: '٣ ساعات'),
        const ShopServiceItem(name: 'إزالة خدوش', price: 350, duration: 'ساعة'),
      ],
